...
`Other/RStudio_server/2024.04.2-764_R_4.4.1` for instance.**
...
xhost +
singularity exec ./RStudio_2024.04.2-764_R_4.4.1.sif rstudio
```
...
Then build the image:
    ...
    singularity build --fakeroot RStudio_2024.04.2-764_R_4.4.1.sif Singularity.def
