...
sed -i.bak -e '/binary.prosite.pfscanv3.path/s/pfscanV3$/pfscanV3.noaf/' -e '/binary.prosite.pfsearchv3.path/s/pfsearchV3$/pfsearchV3.noaf/' interproscan.properties
