...
- Home page: https://cellxgene.cziscience.com/
...
mkdir -p $APPDIR
cd $APPDIR
singularity pull $APP.sif docker://quay.io/ayush_praveen/$APP:$VER
...
whatis("Name: "..appname)
whatis("Version: "..appversion)
whatis("URL: ".."https://github.com/oist/BioinfoUgrp/tree/master/cellxgene")
whatis("Category: ".."bioinformatics")
whatis("Keywords: ".."cellxgene")
whatis("Description: ".."Singularity image to run cellxgene server on a compute node and access from your web browser.")
...
mkdir -p $APPDIR
cd $APPDIR
wget -qO- https://github.com/shenwei356/seqkit/releases/download/v$VER/seqkit_linux_amd64.tar.gz | tar xzvf -
cd $MODROOT/modulefiles/
mkdir -p $APP
cat <<'__END__' > $APP/$VER.lua
-- Default settings
